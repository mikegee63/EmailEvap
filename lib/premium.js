...
module.exports = function createPremium({ transporter, redisClient, log = console.log }) {
  ...
  function mountRoutes(app) {
    ...
    // Operator page at /premium/admin (own login, see lib/premiumAdmin.js)
    require("./premiumAdmin").mount(app, { db, q, env, log, setSessionCookie, purgeAccountData, parseCookies, limiter, LIMITS, STORING_STATUSES });
